...
pub fn menu_bar(ctx: &mut AppContext) -> MenuBar {
    MenuBar::new(vec![
        make_agenterm_app_menu(),
        make_agenterm_file_menu(),
        make_agenterm_edit_menu(),
        make_agenterm_view_menu(),
        make_agenterm_blocks_menu(),
        make_new_window_menu(),
    ])
}

fn make_agenterm_app_menu() -> Menu {
    Menu::new(
        "Agenterm",
        vec![
...
fn make_agenterm_file_menu() -> Menu {
    Menu::new(
        "File",
        vec![
            ...
            MenuItem::Separator,
            local_action_item("Close Window", CustomAction::CloseWindow),
        ],
    )
}

fn make_agenterm_edit_menu() -> Menu {
    Menu::new(
        "Edit",
        vec![
            local_action_item("Copy", CustomAction::Copy),
            MenuItem::Standard(StandardAction::Paste),
            local_action_item("Select All", CustomAction::SelectAll),
            MenuItem::Separator,
            local_action_item("Find", CustomAction::Find),
        ],
    )
}

fn make_agenterm_view_menu() -> Menu {
    Menu::new(
        "View",
        vec![
            local_action_item("Zoom In", CustomAction::IncreaseZoom),
            local_action_item("Zoom Out", CustomAction::DecreaseZoom),
            local_action_item("Actual Size", CustomAction::ResetZoom),
        ],
    )
}

fn make_agenterm_blocks_menu() -> Menu {
    Menu::new(
        "Blocks",
        vec![
            local_action_item("Clear Blocks", CustomAction::ClearBlocks),
            MenuItem::Separator,
            local_action_item("Select Block Above", CustomAction::SelectBlockAbove),
            local_action_item("Select Block Below", CustomAction::SelectBlockBelow),
            local_action_item("Copy Block", CustomAction::CopyBlock),
            local_action_item("Copy Block Command", CustomAction::CopyBlockCommand),
            local_action_item("Copy Block Output", CustomAction::CopyBlockOutput),
        ],
    )
}

fn local_action_item(name: &'static str, action: CustomAction) -> MenuItem {
    MenuItem::Custom(CustomMenuItem::new(
        name,
